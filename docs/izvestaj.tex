...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{../plots/visualizations/01_phase_diagram.png}
\caption{Dijagram faza: dominantna klasa \texttt{which\_better} u prostoru (\texttt{ab\_reach\_depth} $\times$ gustina CHANCE čvorova)}
\end{figure}
